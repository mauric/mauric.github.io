...
**I would to start covering the basics** steps to create a repository using only a Linux/Mac terminal. This is a very common scenario when
you start a project from scratch or after a few version of a project you decide is time to track the code in order to work collaboratively 
in the future uploading it to Github, Gitlab or other platforms. 
